    ...
    <>
      <>
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="flex justify-center font-bold border-cyan-500 border-solid bg-[#86E6FB] h-12"
        >
              ...
              <div className="grid grid-cols-[1fr_2fr] text-[#DCDCDC] gap-3">
                <div className="flex flex-1 flex-col gap-10 items-center h-[50%] w-full">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="w-full flex flex-1 items-center justify-center bg-black"
                  >
                  ...
                  <div className="w-full flex flex-col justify-center gap-10">
                    <div
                      ref={parent}
                      className="h-[calc(112vh-600px)] overflow-y-auto"
                    >
