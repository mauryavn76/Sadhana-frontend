    ...
    <div className="grid md:grid-cols-2 h-full w-full md:px-16 px-6 md:py-16 py-6">
      ...
      <div className="bg-[#FFFFD5] h-full font-medium text-sm my-2">
        <p className="p-2">Ancient science which could not be
          preserved, has a lot of such information,
          which science has now started admitting.
          Science now admits that body cells
          regenerate and replace old cells on their own
          and it is an inbuilt auto process.</p>
          <br />
        <p className="p-2">People have forgotten and have not explored
          its inbuilt capabilities of self-healing, which
          with his other creations makes it fully selfdependent
          </p>
          <br />
          <p className="p-2">All of us should value and respect and make
          best use of the same for humankind. Effort
          has been made to understand and explore
          those capabilities of self-healing by natural
          means
          </p>
          <br />
      <p className="p-2">We are here to assist you in exploring your
      recreational forces within you.
      </p>
      <div className="mr-7">
      <button className="bg-red-400 float-right text-xs text-white font-sans px-2 py-2 rounded-md lg:px-5 lg:py-2 lg:text-xl">
      Know More
      </button>
      </div>
      </div>
