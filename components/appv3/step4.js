          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex justify-center flex-col ">
              <h2 className="text-2xl text-black font-semibold">
                Results according to your selected symptoms
              </h2>
                ...
                {result.map((x, id) => {
                  return (
                    <>
                      <div
                        key={id}
                        className="flex flex-1 gap-2 flex-col overflow-y-auto text-black my-2"
                      >
                        <div>
                          <span
                            onClick={() => setShowResult(true)}
                            className="mx-2 cursor-pointer flex justify-center items-center px-4 border-2 border-solid border-gray-400 h-14"
                          >
                            {x.name} {x.probability}{" "}
                            <ArrowForwardIosIcon className="float-right text-gray-400" />
                          </span>
                        </div>
                      </div>
                    </>
              ...
              {showResult && (
                ...
                >
                  <div className="flex justify-center flex-col items-center">
                    <img
                      className="w-[50%] h-[50%]"
                      src="/images/app/lung-cancer.png"
                    />
                    <h3 className="text-black">Lung Cancer</h3>
                    <p className="text-black text-sm px-2 h-32 overflow-y-auto">
                      Lung cancer is a type of cancer that begins in the lungs.
                      Your lungs are two spongy organs in your chest that take
                      in oxygen when you inhale and release carbon dioxide when
                      you exhale. Lung cancer is the leading cause of cancer
                      deaths worldwide. People who smoke have the greatest risk
                      of lung cancer though lung cancer can also occur in people
                      who have never smoked. The risk of lung cancer increases
                      with the length of time and number of cigarettes youve
                      smoked. If you quit smoking even after smoking for many
                      years you can significantly reduce your chances of
