...
export default function ResultModal() {
  ...
  return (
    <>
      <div className="flex justify-center font-bold border-cyan-500 border-solid bg-[#86E6FB] h-12"></div>
            ...
            <div className="flex flex-1 flex-col gap-10 items-center h-[50%] w-[30%]">
              <div className="flex justify-center items-center">
                ...
                >
                  ...
                  />
                  <Button
                    className="text-teal-600 hover:underline text-xl"
                    onClick={handleOpen}
                  >
                    View Disease Result
                  </Button>
                      ...
                      <Box sx={style}>
                        ...
                        >
                          ...
                          <p className="text-black text-sm px-2 h-32 overflow-y-auto">
                            ...
                            release carbon dioxide when you exhale. Lung cancer
                            is the leading cause of cancer deaths worldwide.
                            People who smoke have the greatest risk of lung
                            cancer though lung cancer can also occur in people
                            who have never smoked. The risk of lung cancer
                            increases with the length of time and number of
                            cigarettes youve smoked. If you quit smoking even
                            after smoking for many years you can significantly
